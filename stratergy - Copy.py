...
def find_stratergy(payoff_matrix, dimension_list):
    ...
    for player in player_list:
        ...
        j = 1  # second pointer, point to other stratergies
        dominant_stratergy = 0  # 0 means no dominant stratergy
        for dimension in range(dimension_list[player - 1]):
            print(
                "comparing 1:",
                i,
                payoff_matrix[player][i],
            ...
            if payoff_matrix[player][i] < payoff_matrix[player][j]:  # Firt comparison
                number_of_comparison = int(
                    (len(payoff_matrix[player])) / dimension_list[player - 1]
                )
                for i in range(number_of_comparison):
                    print(
                        "comparing:",
                        (i + dimension_list[player - 1]),
                        payoff_matrix[player][i + dimension_list[player - 1]],
